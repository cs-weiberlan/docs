...
<AccordionGroup>
  <Accordion title="Fluxos de cartão" icon="credit-card">
    - Emissão de cartões virtuais e físicos (simulados)
    - Ativação e bloqueio
    - Alteração de limites
    - Consulta de dados
  </Accordion>
  <Accordion title="Transações" icon="receipt">
    - Simulação de autorizações
...
<Note>
**TODO:** Revisar tudo que realmente pode ser testado.
</Note>

### Dados de teste

O ambiente Sandbox fornece dados pré-configurados para testes:

<Note>
**TODO:** Listar dados de teste disponíveis (cartões de teste, cenários de erro simulados, etc.).
</Note>
