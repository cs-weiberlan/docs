...
### Causas específicas para POST /credit-card
...
### Causas específicas para GET /content/{attachmentId}
...
| **Endpoint** | URL e método | `POST /credit-card` |
...
<CardGroup cols={2}>
  ...
  <Card title="Endpoint: POST /credit-card" icon="credit-card" href="/api-reference/extrato-cartao">
    Referência técnica do endpoint de extrato.
  </Card>
  <Card title="Endpoint: GET /content/{id}" icon="paperclip" href="/api-reference/download-anexo">
