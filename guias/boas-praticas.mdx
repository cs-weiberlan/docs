...
<Card title="Diagnóstico detalhado" icon="triangle-exclamation" href="/operacao/erros-comuns">
...
2. Faça `GET /content/{attachmentId}` — veja [API Reference](/api-reference/download-anexo)
...
async function downloadAttachment(
  ...
  const response = await fetch(`${baseUrl}/content/${attachmentId}`, {
