...
Para baixar o conteúdo do anexo, use o endpoint [GET /content/{attachmentId}](/api-reference/download-anexo).
...
- Use o endpoint `GET /content/{attachmentId}` para baixar o conteúdo
