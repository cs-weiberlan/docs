...
<Steps>
  ...
  <Step title="Consultar transações de cartão">
    ...
    <CardGroup cols={2}>
      <Card title="Endpoint: POST /statements/v1/credit-card" icon="code" href="/api-reference/extrato-cartao">
  ...
  <Step title="Consumir anexos">
    ...
    **Fluxo:**
    ...
    <CardGroup cols={2}>
      ...
      <Card title="Endpoint: GET /attachments/v1/content/{id}" icon="code" href="/api-reference/download-anexo">
...
| Transações | `POST /statements/v1/credit-card` | [API Reference](/api-reference/extrato-cartao) |
| Anexos | `GET /attachments/v1/content/{attachmentId}` | [API Reference](/api-reference/download-anexo) |
